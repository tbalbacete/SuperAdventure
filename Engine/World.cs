...
namespace Engine
{
    //Building the whole game world. all static because it will not change
    public static class World
    {
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many plants are going here.");
