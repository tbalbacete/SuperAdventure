...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        public SuperAdventure()
        {
            ...
            /* Long-form way of doing the same thing above
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            //Only display buttons for directions the player can go
            ...
            if(newLocation.QuestAvailableHere != null)
            {
                ...
                if(playerAlreadyHasQuest)
                {
                    ...
                    {
                        //Se if the player has all the items needed to complete the quest
        ...
        private void UpdateWeaponListInUI()
        {
            ...
            if(weapons.Count == 0)
            {
                //The player doesnt have any weapons, so hide the weapon combobox and Use button
                cboWeapons.Visible = false;
                btnUseWeapon.Visible = false;
            }
            else
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            //Determine thhe amount of damage to do to the monster
        ...
        private void btnUsePotion_Click(object sender, EventArgs e)
        {
            ...
            //Current hit points cannot exceed player's maximum hitpoints
            ...
            //Subtract the damage from the player
            _player.CurrentHitPoints = _player.CurrentHitPoints -= damageToPlayer;
